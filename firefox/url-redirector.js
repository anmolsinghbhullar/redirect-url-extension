/**
   ...
   It uses the webNavigation API, the script is not persistent (aka it does not run all the
   time, only when the event listener is called (aka an onBeforeNavigate event for a link
   that contains the aforementioned website).
*/
